...
exports.userRoutes.post("/signup", (0, express_validator_1.body)("emailId", "Email id is not valid").trim().isEmail().not().isEmpty(), (0, express_validator_1.body)("password", "Please enter a password with only numbers and text and atleast 8 characters").trim().isLength({ min: 8 }).isAlphanumeric(), (0, express_validator_1.body)("confirmPassword", "Invalid confirm password").trim().isLength({ min: 8 }), User_1.signupUserUsingEmailPassword);
exports.userRoutes.post("/login", (0, express_validator_1.body)("emailId", "Email id is not valid").trim().isEmail().not().isEmpty(), (0, express_validator_1.body)("password", "Please enter a password with only numbers and text and atleast 8 characters").trim().isLength({ min: 8 }).isAlphanumeric(), User_1.loginUserUsingEmailPassword);
